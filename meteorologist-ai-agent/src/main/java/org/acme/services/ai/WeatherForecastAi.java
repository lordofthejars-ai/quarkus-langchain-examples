...
@RegisterAiService(tools = WeatherContentRetriever.class)
public interface WeatherForecastAi {
    ...
    """)
    @UserMessage("""
        You need to search for the weather of given {location} and provide the forecast for the day. 
        """)
    String chat(String location);
